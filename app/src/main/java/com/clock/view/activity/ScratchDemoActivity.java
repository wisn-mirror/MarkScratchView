...
public class ScratchDemoActivity extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScratchView.setEnabled(false);
        btn_start.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mScratchView.setEnabled(true);
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        ...
        } else if (checkedId == R.id.rb_ic) {
            mScratchView.setWatermarkCustomer(R.drawable.mark_repeat_bg, -30, -60, 1.4f,0,0.4f);
        } else if (checkedId == R.id.rb_ic2) {
            mScratchView.setWatermarkCustomer(R.drawable.mark_repeat_bg, 0, 0, 1.3f,60,0.7f);
